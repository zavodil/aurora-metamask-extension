...
module.exports = {
  ...
  overrides: [
...

    {
      ...
      settings: {
        'import/resolver': {
          // Try Node first, then TypeScript. This is a hack, but it prevents
          // issues like "No default export found in imported module
          // 'prop-types'."
          node: {},
          typescript: {
            // TODO: Do we need to turn this on?
            // alwaysTryTypes: true,
          },
        },
      },
     ...
     */
    {
      ...
      settings: {
        'import/resolver': {
          // Try Node first, then TypeScript.
          // This is a hack, but it prevents issues like "No default export
          // found in imported module 'prop-types'."
          node: {},
          typescript: {
            // TODO: Do we need to turn this on?
            // alwaysTryTypes: true,
     ...
     */
    {
      ...
      settings: {
        'import/resolver': {
          // Try TypeScript first, then Node.
          typescript: {
            // TODO: Do we need to turn this on?
            // alwaysTryTypes: true,
          },
